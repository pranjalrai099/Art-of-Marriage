  ...
  return (
    ...
    <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
      ...
      <div className={`flex flex-col gap-3 text-sm text-gray-600 ${showfilter? 'flex':'hidden sm:flex'}`}>
        ...
        <p onClick={()=>speciality==='Chief' ? navigate('/vendors') : navigate('/vendors/Chief')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality==="Chief"? "bg-pink-200 text-black" : ""} `}>Chief</p>
